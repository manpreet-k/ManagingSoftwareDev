...
public class PrefixExpression implements Expression {
	...
	/**
	 * This constructor sets the value for PrefixExpression string for an operator and
	 * expressions
	 * 
	...
	public PrefixExpression(Operator operation, Expression operand1, Expression operand2) {
		prefixText = operation.toString() + SPACE + operand1.textRepresentation() + SPACE + operand2.textRepresentation();
	}
